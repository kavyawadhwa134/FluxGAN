...
if torch.backends.mps.is_available():
    ...
    print('Using CPU')
torch.backends.cudnn.benchmark = False  # Not relevant for MPS/CPU
...
dataloader = DataLoader(dataset, batch_size=batch_size, shuffle=True, pin_memory=False)  # pin_memory=False for MPS
